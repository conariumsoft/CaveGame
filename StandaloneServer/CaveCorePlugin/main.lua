plugin.OnPluginLoad:Bind(function(ev)
    print("PluginLoad!")
end)
plugin.OnPluginUnload:Bind(function(ev)
    print("PluginUnload!")
end)

--server.OnChatMessageFromClient:Bind(function(ev, player, message)
...
server.OnServerCommand:Bind(function(ev, command, args)
