...
namespace CaveGame.Common.Game.Tiles
{
	...
	public class Mycelium : BaseGrass, RandomTileTickable, ITileUpdate, ILocalTileUpdate, ILightEmitter
	{
	...
	public class Grass : BaseGrass, RandomTileTickable, ITileUpdate, ILocalTileUpdate
	{
