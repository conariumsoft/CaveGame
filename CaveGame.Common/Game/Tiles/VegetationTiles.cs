...
namespace CaveGame.Common.Game.Tiles
{
	...
	public class Vine : Tile, RandomTileTickable, INonSolid, ITileUpdate, IWaterBreakable
	{
	...
	public class Tallgrass : Tile, INonSolid, ITileUpdate, IWaterBreakable, RandomTileTickable
	{
		public override byte Hardness => 1;
	...
	public class BlueTallgrass : Tile, INonSolid, ITileUpdate, IWaterBreakable, RandomTileTickable
	{
		public override byte Opacity => 1;
		public override byte Hardness => 1;
		public override Rectangle Quad => TileMap.TallGrass;
