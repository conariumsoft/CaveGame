...
{
    // TypeSerializer.cs
    // Utility class for converting datatypes into and out of byte arrays.
    // In such a way that deals with .NET relying on platform endianness.
    // Author: josh 'brogrammer' o'leary
